...
/* Nested (sub) bullets: indented, no dividers, a dash marker to distinguish level. */
ul.facts ul.facts{margin:.4rem 0 .1rem}
ul.facts ul.facts li{
  border-bottom:none;padding:.3rem 0 .3rem 1.4rem;
  font-size:.95rem;line-height:1.55;
}
ul.facts ul.facts li::before{
  border:none;border-radius:0;width:8px;height:1px;top:1.1rem;
